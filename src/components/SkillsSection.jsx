...
const skills = [
    ...
    {name: "Figma", level: 90, category: "ferramentas"},
    {name: "VS Code", level: 90, category: "ferramentas"},
];
...
export const SkillsSection = () => {
        ...
        const filteredSkiils = skills.filter((skill) => activeCategory === "todas" || skill.category === activeCategory);
